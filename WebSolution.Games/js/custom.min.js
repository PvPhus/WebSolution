var Fillow = function () {
  ...
  var handleRankTop = function () {
    jQuery('.bell-link-1').on('click', function () {
      jQuery('.ranktop').addClass('active');
    });
    jQuery('.ranktop-close').on('click', function () {
      jQuery('.ranktop').removeClass('active');
    });
  }
  ...
  var vHeight = function () {
    ...
    $(".ranktop .msg_card_body").css('height', ch);
  }
